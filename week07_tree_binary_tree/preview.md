...
3. 打开 [examples/binary_tree.c](examples/binary_tree.c)，找到结构体定义或核心数组。
4. 写下一个你不确定的边界输入，课堂上用它检验操作。

## 本周核心操作预告

1. 前序遍历：根、左、右，先不用背代码，先说清楚它改变了哪些对象关系。
2. 中序遍历：左、根、右，先不用背代码，先说清楚它改变了哪些对象关系。
3. 后序遍历：左、右、根，先不用背代码，先说清楚它改变了哪些对象关系。
