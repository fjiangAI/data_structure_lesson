...
4. 说明 前序遍历 的执行过程，并指出它的时间复杂度。

## 代码阅读

5. 阅读 [examples/binary_tree.c](examples/binary_tree.c)，找出初始化函数、核心修改函数和输出函数。
...
11. 向代码大模型提问：“请指出下面这段 二叉树 C 代码的潜在 bug，并给出测试用例。”然后记录模型答案中最有价值的一点和最需要人工核查的一点。
