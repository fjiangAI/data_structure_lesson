...
3. 打开 [examples/min_heap.c](examples/min_heap.c)，找到结构体定义或核心数组。
4. 写下一个你不确定的边界输入，课堂上用它检验操作。

## 本周核心操作预告

1. push：插入尾部后上滤，先不用背代码，先说清楚它改变了哪些对象关系。
2. pop：根与尾交换后下滤，先不用背代码，先说清楚它改变了哪些对象关系。
3. peek：读取根元素，先不用背代码，先说清楚它改变了哪些对象关系。
