...
BUILD = ROOT / "build"
EXE = BUILD / ("lab06_integrated_project" + (".exe" if platform.system().lower().startswith("win") else ""))
...
def main():
    ...
    parser.add_argument("--source", default=str(ROOT / "starter" / "lab06_integrated_project.c"), help="C source file to test.")
