...
BUILD = ROOT / "build"
EXE = BUILD / ("lab04_graph_search" + (".exe" if platform.system().lower().startswith("win") else ""))
...
def main():
    ...
    parser.add_argument("--source", default=str(ROOT / "starter" / "lab04_graph_search.c"), help="C source file to test.")
