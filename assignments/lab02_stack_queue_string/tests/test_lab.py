...
BUILD = ROOT / "build"
EXE = BUILD / ("lab02_stack_queue_string" + (".exe" if platform.system().lower().startswith("win") else ""))
...
def main():
    ...
    parser.add_argument("--source", default=str(ROOT / "starter" / "lab02_stack_queue_string.c"), help="C source file to test.")
