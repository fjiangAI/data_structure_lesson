...
def main():
    ...
    # - 遍历: add one boundary, duplicate, empty, or stress case.
    # - AVL 旋转: add one boundary, duplicate, empty, or stress case.
    # - 堆: add one boundary, duplicate, empty, or stress case.
    # - 递归: add one boundary, duplicate, empty, or stress case.
